    ...
    <div class="flex flex-col text-left">
      <div class="px-5 md:px-9 xl:px-[60px] py-8">
        ...
        <div class="mb-12 bg-zinc-900/50 border border-white/5 p-6 md:p-8">
          <h3 class="text-xs font-black uppercase tracking-[0.3em] text-red-600 mb-6 italic">${t("donate.quick_payment")}</h3>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
            ...
            `,
              ...
              .join("")}
            <input type="number" id="custom-amount" placeholder="${t("donate.custom_amount")}" 
          ...
          <p class="text-[9px] text-gray-500 uppercase mt-4 tracking-wider italic text-center">
            ${t("donate.redirect_note")}
          </p>
        </div>

        <div class="space-y-4 mb-12">
          <h3 class="text-xs font-black uppercase tracking-[0.3em] text-gray-500 mb-6 italic">${t("donate.bank_details")}</h3>
          ${
            item.accounts
              ? item.accounts
                  .map(
        ...
        <div class="p-6 bg-red-600/5 border border-red-600/10 italic">
          <h4 class="text-[10px] font-black uppercase tracking-widest text-red-600 mb-2 italic">${t("donate.purpose_title")}</h4>
